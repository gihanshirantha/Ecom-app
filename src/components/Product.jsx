    ...
    <div>
      ...
      >
        <div className="w-full h-full flex justify-center items-center">
          ...
          <div>
            <div className="absolute top-6 -right-11 group-hover:right-5  bg-[#00ADB5] rounded-md p-2 flex flex-col justify-center items-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-500">
              ...
              <Link
                to={`/products/${id}`}
                className="flex justify-center items-center text-primary bg-white rounded-md w-12 h-12 "
              >
